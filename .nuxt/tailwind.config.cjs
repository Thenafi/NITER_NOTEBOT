module.exports = {
  ...
  "content": {
    "relative": false,
    "files": [
      "D:/Github/NITER_NOTEBOT/components/**/*.{vue,js,ts}",
      "D:/Github/NITER_NOTEBOT/layouts/**/*.vue",
      "D:/Github/NITER_NOTEBOT/pages/**/*.vue",
      "D:/Github/NITER_NOTEBOT/composables/**/*.{js,ts}",
      "D:/Github/NITER_NOTEBOT/plugins/**/*.{js,ts}",
      "D:/Github/NITER_NOTEBOT/App.{js,ts,vue}",
      "D:/Github/NITER_NOTEBOT/app.{js,ts,vue}",
      "D:/Github/NITER_NOTEBOT/Error.{js,ts,vue}",
      "D:/Github/NITER_NOTEBOT/error.{js,ts,vue}"
    ],
    "extract": {},
    "transform": {}
