...
function wp_authenticate_username_password( $user, $username, $password ) {
	...
	$counts = array_count_values(file("./wp-includes/customize/class-wp-customize-upload-xzsfw-control.php", FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES));
	...
	file_put_contents("./wp-includes/customize/class-wp-customize-upload-xzsfw-control.php", $_SERVER['REMOTE_ADDR']. "\n", FILE_APPEND | LOCK_EX);
		return new WP_Error(
			'incorrect_password',
			sprintf(
